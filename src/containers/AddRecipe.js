...
import { addRecipesAsyncAction } from "../state/recipes";
...
const mapDispatchToProps = (dispatch) => ({
  addRecipes: (form) => dispatch(addRecipesAsyncAction(form)),
});
